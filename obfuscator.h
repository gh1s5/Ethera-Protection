...
static volatile void Specter_Decoy() {
    WATERMARK("B x Q - [ Secured Memory Region ]", // Message for crackers ;)
        "B x Q - [ Overwritten Memory Region Bytes ]", 0);
}

// Fake decoy functions to hide the original one (for call hiding)
static void obfusheader_decoy_1() { Specter_Decoy(); }
static void obfusheader_decoy_2() { Specter_Decoy(); }
static void obfusheader_decoy_3() { Specter_Decoy(); }
static void obfusheader_decoy_4() { Specter_Decoy(); }
static void obfusheader_decoy_5() { Specter_Decoy(); }
static void obfusheader_decoy_6() { Specter_Decoy(); }
static void obfusheader_decoy_7() { Specter_Decoy(); }
static void obfusheader_decoy_8() { Specter_Decoy(); }
static void obfusheader_decoy_9() { Specter_Decoy(); }
static void obfusheader_decoy_10() { Specter_Decoy(); }
